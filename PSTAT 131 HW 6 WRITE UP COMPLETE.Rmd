...
```{r}
# fitting rf model to testing data 
best_model <- select_best(multi_tune_res, 
                          metric = "roc_auc")
best_model_final <- finalize_workflow(rf_wkflow,
                                      best_model)
...
augment(best_model_final_fit, new_data = pokemon_test) %>%
...
```
Overall, the model was most accurate at predicting psychic and normal and the worst at predicting grass and water. 
